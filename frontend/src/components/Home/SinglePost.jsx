...
const SinglePost = ({ post, setAllpost, allPost }) => {
  ...
  const deletePost = async () => {
    ...
    if (deletepostresponse) {
      const filtereddata = allPost.filter(
        (posts) => posts.postId !== post.postId
      );
  ...
  const commentSize = async () => {
    ...
    if (commentresponse) setCommentlength(commentresponse.length);
  };

  const updateCommentLength = (length) => {
    console.log(length, "7777777");
  };
      ...
      <>
        ...
        >
          ...
          >
            <div className="flex justify-between">
              <div className="flex">
                ...
                <div
                  className="font-sans font-extralight text-base ms-2 mt-7"
          ...
          <CardBody className="text-center ms-1">
            ...
            <div className="text-gray-400 text-xs">{likelength}likes</div>
            <div className="flex">
