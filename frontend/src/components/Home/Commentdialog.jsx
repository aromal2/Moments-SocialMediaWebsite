...
export function Commentdialog({ open, handleOpen, postId, post,updateCommentlength}) {
  ...
  const addComments = async () => {
    if (comment.trim() !== "") {
      ...
      setCommentId("");
        ...
        updateCommentlength(getcomments.length)
    }
  }
  };
  

  console.log(getcomments.length,"commentsss");

  //  const commentlength=()=>{
  
  //     updateCommentlength("rrrrr")
  //  }
  ...
  const getComment = async () => {
    ...
    console.log(getCommentresponse,"88postIdcommenttttttttttttttttttttttttttttt");
