...
import {
  addMessage,
  getChatlists,
} from "../../api/apiConnections/messageConnection";
...
const Messages = () => {
  ...
  const createChat = async (chattingUserId) => {
    ...
    console.log(
      createchatresponse.messages,
      "888888888888833111111111111111responseeeeee"
    );
  ...
  return (
    <div className="bg-custom-500 h-screen w-screen">
      <div className="flex -mt-3">
        <div className="">
          <div className=" ms-12 mt-12 h-[calc(100vh-10vh)] w-[calc(100vh)]  border border-gray-300 bg-white">
        ...
        <div className="border border-gray-400  w-[calc(100vh)] mt-12  flex flex-col justify-between bg-white">
          <div>
